...
const Page = () => {
    ...
    const tabButtonBase = 'flex-1 px-4 py-[0.8rem] bg-transparent border-none font-semibold cursor-pointer rounded-lg transition-all duration-300 ease-in-out text-[0.95rem]';
    const formGroup = 'mb-6';
    const formLabel = 'block mb-2 text-[#e0e0e0] font-medium text-[0.9rem]';
    const formInput = 'w-full px-5 py-4 bg-[rgba(64,64,64,0.8)] border-2 border-[rgba(64,64,64,0.5)] rounded-xl text-[#e5e7eb] text-base transition-all duration-300 ease-in-out backdrop-blur-lg placeholder-[#9ca3af] focus:outline-none focus:border-[#84cc16] focus:bg-gray-600 focus:ring-4 focus:ring-lime-500/10';
    ...
    return (
        <div className="bg-[rgb(42,42,42)]/95 backdrop-blur-xl p-12 shadow-2xl w-full max-w-md m-8 relative overflow-hidden">
            {/* Barre shimmer */}
            ...
            {activeTab === 'login' ? (
                <div className='text-center mb-10'>
                    <h1 className='text-[2.2rem] text-[#7cb342] mb-2 font-bold'>
                        Bon Retour
                    </h1>
