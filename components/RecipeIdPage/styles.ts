...
export const styles = {
    ...
    // Ingrédients
    ingredientItem: 'bg-[#3a3a3a] p-4 rounded-[10px] border-l-4 border-[#3b82f6] transition-all duration-300 ease-in-out hover:bg-[#424242] hover:-translate-x-[5px]',
    ingredientName: 'font-medium text-[#e0e0e0] flex-1',
    ingredientQuantity: 'text-[#3b82f6] font-bold text-[0.9rem] whitespace-nowrap',
