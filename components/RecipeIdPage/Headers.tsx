...
const Header = ({ recipe, currentServings, onServingsChange }: HeaderProps) => {
    ...
    return (
        <header className='bg-gradient-to-br from-[#2a2a2a] to-[#1f1f1f] rounded-[20px] overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.3)] mb-8'>
            <div className='relative h-[400px] bg-gradient-to-br from-[#3b82f6] to-[#64748b] flex justify-center items-center text-[8rem] text-white max-md:h-[250px] max-md:text-[4rem]' style={{ backgroundImage: `url(${recipe.image})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
