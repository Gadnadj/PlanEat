export const styles = {
    ...
    recipeTag: 'bg-gradient-to-br from-[#3a3a3a] to-[#2d2d2d] rounded-[15px] overflow-hidden transition-all duration-300 ease-in-out border border-[#404040] relative hover:-translate-y-2 hover:shadow-[0_15px_40px_rgba(0,0,0,0.4)] hover:border-[#3b82f6] flex flex-col h-full',
    ...
    recipeInfo: 'p-6 flex flex-col flex-grow',
    recipeTitle: 'text-[#3b82f6] mb-[0.8rem] text-[1.4rem] font-bold',
    recipeDescription: 'text-[#b0b0b0] mb-4 text-base leading-relaxed h-12 overflow-hidden',
    recipeTags: 'flex gap-2 mb-[1.5rem] wrap h-8 overflow-hidden',
    recipeTagss: 'bg-[#404040] text-[#e0e0e0] py-[0.3rem] px-[0.8rem] rounded-[12px] text-[0.8rem]',
    recipeStats: 'flex justify-between items-center mb-6 p-4 bg-[rgba(30,41,59,0.4)] rounded-[8px] mt-auto',
    statItem: 'text-center',
    statValue: 'font-bold text-[#3b82f6] text-[1.1rem]',
    statLabel: 'text-[0.8rem] text-[#b0b0b0]',
    recipeAction: 'flex gap-2 max-md:flex-col mt-auto',
